...
namespace yiiframe\logistics\Providers;

use yiiframe\logistics\Exceptions\HttpException;
use yiiframe\logistics\Exceptions\InquiryErrorException;
use yiiframe\logistics\Exceptions\InvalidArgumentException;
use yiiframe\logistics\Interfaces\JuheConfigurationConstant;
use yiiframe\logistics\Order;
use yiiframe\logistics\Traits\HasHttpRequest;
...
class Juhe extends AbstractProvider implements JuheConfigurationConstant
{
     ...
     * @param null $company
     *
     * @return \yiiframe\logistics\Order
     *
     * @throws \yiiframe\logistics\Exceptions\HttpException
     * @throws \yiiframe\logistics\Exceptions\InquiryErrorException
     * @throws \yiiframe\logistics\Exceptions\InvalidArgumentException
     */
